...
for bitRate in bitRates:
    # os.system('mkdir {:}/analysisData/{:}/'.format(rootPath, bitRate))
    ...
    os.system('cd {:}/analysisData/ref/ && ffmpeg -i bit_rate_{:}.mp4 -i bit_rate_ref.mp4 -lavfi ssim=stats_file=ssim_logfile_{:}.txt -f null -'.format(rootPath,bitRate,bitRate))
