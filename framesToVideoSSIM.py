...
for bitRate in bitRates:
    os.system('cd {:}/analysisData/ref/ && ffmpeg -y -r 30 -f image2 -s 1920x1080 -pattern_type glob -i "*color.png" -vcodec libx264 -pix_fmt yuv420p -b:v {:} bit_rate_{:}.mp4'.format(rootPath, bitRate, bitRate))
...
# move the video and ssim files generated in analysisData/ref/ to analysisData/video

os.system('mv ' + rootPath + '/analysisData/ref/bit_rate* ' + rootPath + '/analysisData/video')
os.system('mv ' + rootPath + '/analysisData/ref/ssim* ' + rootPath + '/analysisData/video')
